...
Public Class MainForm
	...
	Private sales() As Integer = {0, 0, 0, 0, 0}
	...
	Private Sub MainForm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		...
		idListBox.Items.Add(101)
		idListBox.Items.Add(112)
		idListBox.Items.Add(203)
		idListBox.Items.Add(301)
		idListBox.Items.Add(302)
	...
	Private Sub createButton_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles createButton.Click
		...
		reportTextBox.Text = reportTextBox.Text & ControlChars.NewLine & "Total: $" & companySales.ToString
	End Sub
End Class
